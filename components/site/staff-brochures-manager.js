...
import { StaffConsoleFrame } from "@/components/site/staff-console-frame";
import { brochureLinkHref, localize } from "@/lib/site-content";
import {
                ...
                <article key={item.id} className="staff-record-card">
                  ...
                  <div className="staff-record-copy">
                    ...
                    <div className="staff-record-actions">
                      <a
                        href={preview.openUrl || brochureLinkHref}
                        target="_blank"
                        rel="noreferrer"
