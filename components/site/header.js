...
import { headerContent, localize, navItems, staffNavItems, storeProfile } from "@/lib/site-content";
...
export function SiteHeader() {
  ...
  const links = localize(isStaffPage ? staffNavItems : navItems, language);
