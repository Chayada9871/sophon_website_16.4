...
const fallbackSupabaseUrl = "https://ajecxsbfvxurdxrssdqn.supabase.co";
const fallbackSupabaseKey = "sb_publishable_Gs7_Llbh2pPjthTY4YJQ_A_qUNLJF_T";

const supabaseUrl = String(process.env.NEXT_PUBLIC_SUPABASE_URL || fallbackSupabaseUrl).trim();
const supabaseKey = String(process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || fallbackSupabaseKey).trim();
